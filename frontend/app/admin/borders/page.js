      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="p-6">
          ...
          <div className="mb-6 border-b border-gray-200">
            <div className="flex flex-wrap gap-2">
              {[
                ...
                >
                  {cat.label} ({cat.key === 'all' ? borders.length : borders.filter(b => b.category === cat.key).length})
                </button>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {borders.filter(border => activeCategory === 'all' || border.category === activeCategory).map((border) => (
          ...
          {borders.filter(border => activeCategory === 'all' || border.category === activeCategory).length === 0 && (
