        ...
        >
          ...
          <div className="aspect-square">
            <ExactFitPhotoFrame
              ...
              aspectRatio={photo.aspect_ratio || '1:1'}
          ...
          {photos.map((photo, index) => (
            <div key={index} className="min-w-full px-4">
              <ExactFitPhotoFrame
                photoUrl={photo.photo_url}
                borderUrl={photo.border_url}
                aspectRatio={photo.aspect_ratio || '16:9'}
                feather={borderFeather}
      ...
      {photos.length > 1 && (
        <>
          <button
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 bg-white/80 rounded-full p-2 hover:bg-white transition-all shadow-lg"
          >
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button
            onClick={() => setCurrentSlide((prev) => (prev < photos.length - 1 ? prev + 1 : 0))}
            className="absolute right-2 top-1/2 -translate-y-1/2 bg-white/80 rounded-full p-2 hover:bg-white transition-all shadow-lg"
          >
    ...
    <AnimatePresence>
      {lightboxIndex !== null && (
        ...
        >
          ...
          <motion.div
            key={lightboxIndex}
            className="max-w-6xl max-h-[90vh] w-full p-8"
          ...
          >
            <ExactFitPhotoFrame
              ...
              aspectRatio={photos[lightboxIndex].aspect_ratio || '4:3'}
              feather={borderFeather}
              className="w-full h-full"
            />
