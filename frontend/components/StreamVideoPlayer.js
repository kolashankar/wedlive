...
export default function StreamVideoPlayer({ 
  ...
  // Debug: Log the themeId to see what we're receiving
  console.log('StreamVideoPlayer - themeId:', themeId, 'type:', typeof themeId);
  console.log('StreamVideoPlayer - is modern-minimalist:', themeId === 'modern-minimalist');
