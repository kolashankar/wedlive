...
`https://multivue-stream.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://multivue-stream.preview.emergentagent.com`
- API calls to: `https://multivue-stream.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://multivue-stream.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://multivue-stream.preview.emergentagent.com",
...
```
Request URL: https://multivue-stream.preview.emergentagent.com/api/auth/login
Request Method: POST
