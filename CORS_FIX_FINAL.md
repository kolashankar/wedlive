...
`https://stream-sound-hub.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://stream-sound-hub.preview.emergentagent.com`
- API calls to: `https://stream-sound-hub.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://stream-sound-hub.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://stream-sound-hub.preview.emergentagent.com",
...
```
Request URL: https://stream-sound-hub.preview.emergentagent.com/api/auth/login
Request Method: POST
