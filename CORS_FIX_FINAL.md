...
`https://template-loader-1.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://template-loader-1.preview.emergentagent.com`
- API calls to: `https://template-loader-1.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://template-loader-1.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://template-loader-1.preview.emergentagent.com",
...
```
Request URL: https://template-loader-1.preview.emergentagent.com/api/auth/login
Request Method: POST
