...
`https://overlay-fix-3.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://overlay-fix-3.preview.emergentagent.com`
- API calls to: `https://overlay-fix-3.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://overlay-fix-3.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://overlay-fix-3.preview.emergentagent.com",
...
```
Request URL: https://overlay-fix-3.preview.emergentagent.com/api/auth/login
Request Method: POST
