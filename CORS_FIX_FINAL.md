...
`https://telegram-viewer-1.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://telegram-viewer-1.preview.emergentagent.com`
- API calls to: `https://telegram-viewer-1.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://telegram-viewer-1.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://telegram-viewer-1.preview.emergentagent.com",
...
```
Request URL: https://telegram-viewer-1.preview.emergentagent.com/api/auth/login
Request Method: POST
