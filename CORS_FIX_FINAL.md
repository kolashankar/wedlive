...
`https://wedlive-connect.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://wedlive-connect.preview.emergentagent.com`
- API calls to: `https://wedlive-connect.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://wedlive-connect.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://wedlive-connect.preview.emergentagent.com",
...
```
Request URL: https://wedlive-connect.preview.emergentagent.com/api/auth/login
Request Method: POST
