...
`https://image-service-2.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://image-service-2.preview.emergentagent.com`
- API calls to: `https://image-service-2.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://image-service-2.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://image-service-2.preview.emergentagent.com",
...
```
Request URL: https://image-service-2.preview.emergentagent.com/api/auth/login
Request Method: POST
