...
`https://stream-overlay-debug.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://stream-overlay-debug.preview.emergentagent.com`
- API calls to: `https://stream-overlay-debug.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://stream-overlay-debug.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://stream-overlay-debug.preview.emergentagent.com",
...
```
Request URL: https://stream-overlay-debug.preview.emergentagent.com/api/auth/login
Request Method: POST
