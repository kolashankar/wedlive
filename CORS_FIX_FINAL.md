...
`https://responsive-text-fix-1.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://responsive-text-fix-1.preview.emergentagent.com`
- API calls to: `https://responsive-text-fix-1.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://responsive-text-fix-1.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://responsive-text-fix-1.preview.emergentagent.com",
...
```
Request URL: https://responsive-text-fix-1.preview.emergentagent.com/api/auth/login
Request Method: POST
