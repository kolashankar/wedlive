...
`https://video-overlay-sync.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://video-overlay-sync.preview.emergentagent.com`
- API calls to: `https://video-overlay-sync.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://video-overlay-sync.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://video-overlay-sync.preview.emergentagent.com",
...
```
Request URL: https://video-overlay-sync.preview.emergentagent.com/api/auth/login
Request Method: POST
