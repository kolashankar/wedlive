...
`https://streamswitch-1.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://streamswitch-1.preview.emergentagent.com`
- API calls to: `https://streamswitch-1.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://streamswitch-1.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://streamswitch-1.preview.emergentagent.com",
...
```
Request URL: https://streamswitch-1.preview.emergentagent.com/api/auth/login
Request Method: POST
