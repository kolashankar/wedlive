...
`https://audio-bug-patch.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://audio-bug-patch.preview.emergentagent.com`
- API calls to: `https://audio-bug-patch.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://audio-bug-patch.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://audio-bug-patch.preview.emergentagent.com",
...
```
Request URL: https://audio-bug-patch.preview.emergentagent.com/api/auth/login
Request Method: POST
