...
`https://overlay-timing-2.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://overlay-timing-2.preview.emergentagent.com`
- API calls to: `https://overlay-timing-2.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://overlay-timing-2.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://overlay-timing-2.preview.emergentagent.com",
...
```
Request URL: https://overlay-timing-2.preview.emergentagent.com/api/auth/login
Request Method: POST
