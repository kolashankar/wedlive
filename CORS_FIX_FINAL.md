...
`https://wedlive-frame.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://wedlive-frame.preview.emergentagent.com`
- API calls to: `https://wedlive-frame.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://wedlive-frame.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://wedlive-frame.preview.emergentagent.com",
...
```
Request URL: https://wedlive-frame.preview.emergentagent.com/api/auth/login
Request Method: POST
