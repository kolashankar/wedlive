...
`https://camera-composer.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://camera-composer.preview.emergentagent.com`
- API calls to: `https://camera-composer.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://camera-composer.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://camera-composer.preview.emergentagent.com",
...
```
Request URL: https://camera-composer.preview.emergentagent.com/api/auth/login
Request Method: POST
