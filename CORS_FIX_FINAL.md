...
`https://photoframe-sync.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://photoframe-sync.preview.emergentagent.com`
- API calls to: `https://photoframe-sync.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://photoframe-sync.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://photoframe-sync.preview.emergentagent.com",
...
```
Request URL: https://photoframe-sync.preview.emergentagent.com/api/auth/login
Request Method: POST
