...
`https://text-color-fix-1.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://text-color-fix-1.preview.emergentagent.com`
- API calls to: `https://text-color-fix-1.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://text-color-fix-1.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://text-color-fix-1.preview.emergentagent.com",
...
```
Request URL: https://text-color-fix-1.preview.emergentagent.com/api/auth/login
Request Method: POST
