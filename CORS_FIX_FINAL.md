...
`https://livekit-upgrade.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://livekit-upgrade.preview.emergentagent.com`
- API calls to: `https://livekit-upgrade.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://livekit-upgrade.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://livekit-upgrade.preview.emergentagent.com",
...
```
Request URL: https://livekit-upgrade.preview.emergentagent.com/api/auth/login
Request Method: POST
