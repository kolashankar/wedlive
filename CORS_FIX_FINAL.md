...
`https://weddingslides.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://weddingslides.preview.emergentagent.com`
- API calls to: `https://weddingslides.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://weddingslides.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://weddingslides.preview.emergentagent.com",
...
```
Request URL: https://weddingslides.preview.emergentagent.com/api/auth/login
Request Method: POST
