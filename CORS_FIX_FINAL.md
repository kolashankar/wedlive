...
`https://mediapositionfix.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://mediapositionfix.preview.emergentagent.com`
- API calls to: `https://mediapositionfix.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://mediapositionfix.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://mediapositionfix.preview.emergentagent.com",
...
```
Request URL: https://mediapositionfix.preview.emergentagent.com/api/auth/login
Request Method: POST
