...
`https://overlay-sync-fix.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://overlay-sync-fix.preview.emergentagent.com`
- API calls to: `https://overlay-sync-fix.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://overlay-sync-fix.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://overlay-sync-fix.preview.emergentagent.com",
...
```
Request URL: https://overlay-sync-fix.preview.emergentagent.com/api/auth/login
Request Method: POST
