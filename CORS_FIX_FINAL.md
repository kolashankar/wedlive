...
`https://video-player-swap.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://video-player-swap.preview.emergentagent.com`
- API calls to: `https://video-player-swap.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://video-player-swap.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://video-player-swap.preview.emergentagent.com",
...
```
Request URL: https://video-player-swap.preview.emergentagent.com/api/auth/login
Request Method: POST
