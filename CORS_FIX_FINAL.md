...
`https://template-media-fix.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://template-media-fix.preview.emergentagent.com`
- API calls to: `https://template-media-fix.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://template-media-fix.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://template-media-fix.preview.emergentagent.com",
...
```
Request URL: https://template-media-fix.preview.emergentagent.com/api/auth/login
Request Method: POST
