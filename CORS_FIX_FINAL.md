...
`https://loading-repair-2.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://loading-repair-2.preview.emergentagent.com`
- API calls to: `https://loading-repair-2.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://loading-repair-2.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://loading-repair-2.preview.emergentagent.com",
...
```
Request URL: https://loading-repair-2.preview.emergentagent.com/api/auth/login
Request Method: POST
