...
`https://livestream-checker.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://livestream-checker.preview.emergentagent.com`
- API calls to: `https://livestream-checker.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://livestream-checker.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://livestream-checker.preview.emergentagent.com",
...
```
Request URL: https://livestream-checker.preview.emergentagent.com/api/auth/login
Request Method: POST
