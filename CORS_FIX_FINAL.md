...
`https://focused-layer-fx.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://focused-layer-fx.preview.emergentagent.com`
- API calls to: `https://focused-layer-fx.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://focused-layer-fx.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://focused-layer-fx.preview.emergentagent.com",
...
```
Request URL: https://focused-layer-fx.preview.emergentagent.com/api/auth/login
Request Method: POST
