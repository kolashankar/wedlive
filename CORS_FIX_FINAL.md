...
`https://livestream-testing.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://livestream-testing.preview.emergentagent.com`
- API calls to: `https://livestream-testing.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://livestream-testing.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://livestream-testing.preview.emergentagent.com",
...
```
Request URL: https://livestream-testing.preview.emergentagent.com/api/auth/login
Request Method: POST
