...
`https://music-livestream.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://music-livestream.preview.emergentagent.com`
- API calls to: `https://music-livestream.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://music-livestream.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://music-livestream.preview.emergentagent.com",
...
```
Request URL: https://music-livestream.preview.emergentagent.com/api/auth/login
Request Method: POST
