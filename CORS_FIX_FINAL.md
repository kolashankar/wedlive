...
`https://layout-update-4.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://layout-update-4.preview.emergentagent.com`
- API calls to: `https://layout-update-4.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://layout-update-4.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://layout-update-4.preview.emergentagent.com",
...
```
Request URL: https://layout-update-4.preview.emergentagent.com/api/auth/login
Request Method: POST
