...
`https://anim-slideshow.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://anim-slideshow.preview.emergentagent.com`
- API calls to: `https://anim-slideshow.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://anim-slideshow.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://anim-slideshow.preview.emergentagent.com",
...
```
Request URL: https://anim-slideshow.preview.emergentagent.com/api/auth/login
Request Method: POST
