...
`https://studio-logo-removal.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://studio-logo-removal.preview.emergentagent.com`
- API calls to: `https://studio-logo-removal.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://studio-logo-removal.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://studio-logo-removal.preview.emergentagent.com",
...
```
Request URL: https://studio-logo-removal.preview.emergentagent.com/api/auth/login
Request Method: POST
