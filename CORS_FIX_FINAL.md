...
`https://font-change-patch.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://font-change-patch.preview.emergentagent.com`
- API calls to: `https://font-change-patch.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://font-change-patch.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://font-change-patch.preview.emergentagent.com",
...
```
Request URL: https://font-change-patch.preview.emergentagent.com/api/auth/login
Request Method: POST
