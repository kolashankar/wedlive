...
`https://studio-partner-img.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://studio-partner-img.preview.emergentagent.com`
- API calls to: `https://studio-partner-img.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://studio-partner-img.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://studio-partner-img.preview.emergentagent.com",
...
```
Request URL: https://studio-partner-img.preview.emergentagent.com/api/auth/login
Request Method: POST
