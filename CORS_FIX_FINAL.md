...
`https://audiostream-deck.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://audiostream-deck.preview.emergentagent.com`
- API calls to: `https://audiostream-deck.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://audiostream-deck.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://audiostream-deck.preview.emergentagent.com",
...
```
Request URL: https://audiostream-deck.preview.emergentagent.com/api/auth/login
Request Method: POST
