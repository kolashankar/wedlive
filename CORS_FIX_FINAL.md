...
`https://audio-manager-1.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://audio-manager-1.preview.emergentagent.com`
- API calls to: `https://audio-manager-1.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://audio-manager-1.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://audio-manager-1.preview.emergentagent.com",
...
```
Request URL: https://audio-manager-1.preview.emergentagent.com/api/auth/login
Request Method: POST
