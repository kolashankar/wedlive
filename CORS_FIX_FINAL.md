...
`https://studio-image-only.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://studio-image-only.preview.emergentagent.com`
- API calls to: `https://studio-image-only.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://studio-image-only.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://studio-image-only.preview.emergentagent.com",
...
```
Request URL: https://studio-image-only.preview.emergentagent.com/api/auth/login
Request Method: POST
