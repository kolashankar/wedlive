...
`https://media-stream-fix-6.preview.emergentagent.com/api/auth/login`
...
- Frontend at: `https://media-stream-fix-6.preview.emergentagent.com`
- API calls to: `https://media-stream-fix-6.preview.emergentagent.com/api/auth/login`
...
Open browser console at `https://media-stream-fix-6.preview.emergentagent.com` and check:
...
🔧 Configuration Validation: {
  apiBaseUrl: "https://media-stream-fix-6.preview.emergentagent.com",
...
```
Request URL: https://media-stream-fix-6.preview.emergentagent.com/api/auth/login
Request Method: POST
