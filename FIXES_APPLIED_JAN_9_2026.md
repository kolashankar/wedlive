...
- **Old URL**: `https://livestream-checker.preview.emergentagent.com`
- **Actual deployment**: `https://livestream-checker.preview.emergentagent.com`
...
```diff
- NEXT_PUBLIC_API_URL=https://livestream-checker.preview.emergentagent.com
- NEXT_PUBLIC_BACKEND_URL=https://livestream-checker.preview.emergentagent.com
- REACT_APP_BACKEND_URL=https://livestream-checker.preview.emergentagent.com
+ NEXT_PUBLIC_API_URL=https://livestream-checker.preview.emergentagent.com
+ NEXT_PUBLIC_BACKEND_URL=https://livestream-checker.preview.emergentagent.com
+ REACT_APP_BACKEND_URL=https://livestream-checker.preview.emergentagent.com
```
...
+ BACKEND_URL=https://livestream-checker.preview.emergentagent.com
```
...
```
https://livestream-checker.preview.emergentagent.com/api/media/telegram-proxy/documents/BQACAgUAAyEGAATO7nwaAAOQaU_fIOrovv7dezINOwV2YbmCD94AAvIcAALG7oBWyaY-YZXnkyc2BA
```
✅ Bot token hidden
...
```
https://livestream-checker.preview.emergentagent.com/api/media/proxy?url=https%3A%2F%2Fapi.telegram.org%2Ffile%2F...
```
...
# Output:
# cdn_url: https://livestream-checker.preview.emergentagent.com/api/media/telegram-proxy/documents/BQACAgUAAyEGAATO7nwaAAOQaU_fIOrovv7dezINOwV2YbmCD94AAvIcAALG7oBWyaY-YZXnkyc2BA
...
# Output:
# Total: 23
# First URL: https://livestream-checker.preview.emergentagent.com/api/media/telegram-proxy/documents/BQACAgUAAyEGAATO7nwaAAO4aVYQYVQSUgT1hVeT4lhw7O1hto8AAqUfAAJa2LBWvY9_nCIEKzM4BA
```
...
2. **Test Login**: Try logging in via the UI at `https://livestream-checker.preview.emergentagent.com`
