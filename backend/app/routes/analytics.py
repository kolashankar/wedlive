...
async def get_wedding_sessions(
    ...
    if current_user["role"] != "admin" and wedding["creator_id"] != current_user["id"]:
...
async def record_stream_quality(metric: StreamQualityMetric):
    ...
    metric_doc = {
        ...
        "buffering_events": metric.buffering_events,
        "buffering_duration_ms": metric.buffering_duration_ms,
        "fps": metric.fps,
...
async def get_engagement_metrics(
    ...
    return EngagementMetrics(
        ...
        peak_time=peak_time,
        average_watch_duration=avg_duration,
        total_chat_messages=total_chat,
        total_reactions=total_reactions,
        total_guest_book_entries=total_guest_book,
        total_photo_booth_photos=total_photo_booth,
        viewer_timezones=timezone_distribution
    )
...
async def get_analytics_dashboard(
    ...
    return AnalyticsDashboard(
        wedding_id=wedding_id,
        stream_quality=quality_stats,
        viewer_stats=viewer_stats,
        engagement_metrics=engagement,
        peak_viewership_timeline=timeline,
