    ...
    default_themes = [
        {
            "id": "floral-garden",
            "name": "Floral Garden",
            "description": "Elegant floral theme with romantic garden vibes",
            "preview_image": "",
            "required_sections": {
                "bride_photo": True,
                "groom_photo": True,
        ...
        },
        {
            "id": "royal-palace",
            "name": "Royal Palace",
            "description": "Luxurious palace-inspired theme with golden accents",
            "preview_image": "",
            "required_sections": {
                "bride_photo": True,
                "groom_photo": True,
        ...
        },
        {
            "id": "cinema-scope",
            "name": "Cinema Scope",
            "description": "Cinematic widescreen theme for modern weddings",
            "preview_image": "",
            "required_sections": {
                "bride_photo": True,
                "groom_photo": True,
        ...
        },
        {
            ...
            "description": "Soft pastel colors with dreamy romantic feel",
            "preview_image": "",
            "required_sections": {
                "bride_photo": True,
                "groom_photo": True,
        ...
        {
            "id": "premium-wedding-card",
            "name": "Premium Wedding Card",
            "description": "Traditional wedding card design",
            "preview_image": "",
            "required_sections": {
                "bride_photo": True,
                "groom_photo": True,
        ...
        },
        {
            ...
            "description": "Classic South Indian wedding theme",
            "preview_image": "",
            "required_sections": {
                "bride_photo": True,
                "groom_photo": True,
